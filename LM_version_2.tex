...
\begin{frame}[label=current]{Ongoing: optimizing primer batch for targeted enrichment of regions of interest}
  Maximizing coverage density of kmers enriched in regions of interest $\longrightarrow$ Log2(FC) between kmer abundance of ROI and genomic kmer abundance (\textbf{Differential evolution algorithm})
  \begin{itemize}
    \item CTCF sites
    \begin{figure}
      \includegraphics[scale=0.1]{CTCF_meth.png}
    \end{figure}

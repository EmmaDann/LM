...
\begin{frame}{Uneven coverage in scBS-seq data}
  ...
  \onslide<2>{
  \begin{center}
    \alert{\large{Can we understand (and maybe hack) the source \\
    of this coverage bias?}}
  \end{center}
  }
\end{frame}
%
% \begin{frame}{Post-Bisulfite Adaptor Tagging (scPBAT)}
%   \begin{figure}
%       \includegraphics[scale=0.35]{wolf_reik_prot_preamp.png}
%   \end{figure}
...
% % \end{frame}
%
% \begin{frame}{Random priming as a source of bias}
%   \vspace{-0.2cm}
%   \begin{figure}
%       \includegraphics[scale = 0.18]{ligationVSpriming_chr1_covprofile.pdf}
%   \end{figure}
%   \vspace{-0.2cm}
%   \begin{figure}
%       \includegraphics[scale = 0.3, trim={0cm 0cm 0cm 9cm}, clip]{biased_usage.pdf}
%   \end{figure}
% \end{frame}
%
...
%   \begin{figure}
%       \centering
%       \includegraphics[scale=0.4]{template_primer.png}
%   \end{figure}
%   % \begin{columns}
%   %     \begin{column}{0.4\linewidth}
%       \begin{equation*}
%         p+t \rightleftarrows pt,
%       \end{equation*}
%       p = primer\\
%       t = free template sequence\\
%       pt = bound template sequence\\
%     \begin{equation*}
%       \frac{[pt]}{[p][t]} = \exp\left(\beta\Delta G\right).
%     \end{equation*}
%     Binding dependant on:
%     \begin{itemize}
%       \item Total number of template sequences $T = t+pt$
%       \item Binding free energy $\Delta G$
%     \end{itemize}
%   %     \end{column}
...
%   \end{equation*}
%   \begin{figure}
%       \only<1>{\includegraphics[scale=0.47,page=12, trim={0 2cm 0 2cm}, clip]{counting-3.pdf}}
%       \only<2>{\includegraphics[scale=0.47,page=13, trim={0 2cm 0 2cm}, clip]{counting-3.pdf}}
%       \only<3-4>{\includegraphics[scale=0.47,page=14, trim={0 2cm 0 2cm}, clip]{counting-3.pdf}}
%   \end{figure}
%   \onslide<4>{
